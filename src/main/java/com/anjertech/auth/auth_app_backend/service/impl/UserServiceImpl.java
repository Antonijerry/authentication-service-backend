...
import com.anjertech.auth.auth_app_backend.entity.Provider;
...
import com.anjertech.auth.auth_app_backend.helpers.UserHelper;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto creatUser(UserDto userDto) {
        ...
        //if you have other extra check before creating a new user, put here...

        //to convert the object dto to entity
        User user = modelMapper.map(userDto, User.class);
        user.setProvider(userDto.getProvider()!=null ? userDto.getProvider() : Provider.LOCAL);
        //role assign here to user____ for authorization
        //TODO
    ...
    public UserDto updateUser(UserDto userDto, String userId) {
        ...
        //you can change the password update logic here
