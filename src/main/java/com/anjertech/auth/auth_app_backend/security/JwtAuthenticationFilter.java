...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    //this helps to print the authorization header at the cmd as Authorization header: ......
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (header!=null && header.startsWith("Bearer ")){
            ...
            //token extract and validate then authentication create and then security context ke under set karunga.
    ...
    //this code is added after testing for the login method in no. 4a
//    @Override
